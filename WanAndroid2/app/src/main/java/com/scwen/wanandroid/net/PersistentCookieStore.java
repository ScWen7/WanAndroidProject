...
public class PersistentCookieStore implements CookieStore {
    ...
    private static final String COOKIE_PREFS = Constant.COOKIE_SP;        //cookie使用prefs保存
    private static final String COOKIE_NAME_PREFIX = Constant.COOKIE_NAME_PREFIX;          //cookie持久化的统一前缀

    private final HashMap<String, ConcurrentHashMap<String, Cookie>> cookies;
    private final SharedPreferences cookiePrefs;

    public PersistentCookieStore() {
        cookiePrefs = App.Companion.getContext().getSharedPreferences(COOKIE_PREFS, Context.MODE_PRIVATE);
        cookies = new HashMap<>();
